        ...
        GoRouteData.$route(
          ...
          routes: [
            GoRouteData.$route(
              ...
              parentNavigatorKey: IncidentDetailRoute.$parentNavigatorKey,

              factory: _$IncidentDetailRoute._fromState,
            ),
          ],
        ),
      ],
...
mixin _$IncidentDetailRoute on GoRouteData {
  static IncidentDetailRoute _fromState(GoRouterState state) =>
      IncidentDetailRoute($extra: state.extra as IncidentDetailArgs);

  IncidentDetailRoute get _self => this as IncidentDetailRoute;

  @override
  String get location => GoRouteData.$location('/incidents/incident-detail');
...
mixin _$ResetPasswordRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location('/profile/reset');
