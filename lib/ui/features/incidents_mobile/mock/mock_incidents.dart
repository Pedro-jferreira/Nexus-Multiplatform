...
class MockIncidents {
  static List<IncidentModel> incidents = [
    IncidentModel(
      ...
      dataCaptura: DateTime.now().subtract(const Duration(minutes: 5))
    ),
    IncidentModel(
        ...
        grauSimilaridade: 0.98,
        fotoUrl: "assets/images/foto1_suspeito.png",
        dataCaptura: DateTime.now().subtract(const Duration(days: 1))
    ),
    IncidentModel(
    ...
    IncidentModel(
        ...
        fotoUrl: "assets/images/foto1_suspeito.png",
        dataCaptura: DateTime.now().subtract(const Duration(days: 4))
    ),
  ];
}